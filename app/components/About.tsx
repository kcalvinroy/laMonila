    ...
    <section className="mx-auto max-w-2xl px-4 sm:pb-6 lg:max-w-7xl lg:px-8">
      <div className="mb-8 flex flex-wrap justify-between md:mb-16 ">
        <div className="mb-6 flex w-full flex-col justify-center sm:mb-12 lg:mb-0 lg:w-1/2 lg:pb-12 lg:pt-24">
          <h1 className="mb-4 mt-4 text-4xl font-bold text-black sm:text-5xl md:mb-8 md:text-6xl">
            About La Monila
          </h1>
        ...
        <div className="mb-12 flex w-full items-center max-sm:justify-center md:mb-16 lg:w-1/2">
      ...
      <div className="flex items-center max-sm:justify-center gap-8 md:flex-row">
        <div className="flex h-16 w-64 rounded-lg border bg-primary hover:bg-primary/80">
          <a
            href="/Profile.pdf"
            className="flex text-lg w-full hover:scale-105 font-semibold text-red-50 items-center justify-center ease-in-out transition duration-100 active:bg-primary/80"
          >
            Company Profile
